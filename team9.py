...
def move(my_history, their_history, my_score, their_score):
    ...
    if 1 <= len(my_history) + 1 and len(my_history) <= 10: #rounds 1-10 will be random
        return random.choice(choices)
    elif 11 <= len(my_history) + 1 and len(my_history) <= 20: #if they alternate, return b
        if "cbcb" in their_history:
            return "b"
        else:
            return "c"
    elif 21 <= len(my_history) + 1 and len(my_history) <= 30: #If they betray > 50%, betray
        countB = 0
	...
	if float(countB)/len(their_history) > 0.5:
	    ...
	    return "c"
    elif 31 <= len(my_history) + 1 and len(my_history) <= 40: #if they betray, random. else, betray
        if their_history[len(their_history)] == "b":
            return random.choice(choices)
        else:
            return "b"
    elif 41 <= len(my_history) + 1 and len(my_history) <= 50: #If collude > 50%, betray
        countC = 0
        for letter in their_history:
	   if letter == "c":
	       countC += 1
	if float(countC)/len(their_history) > 0.5:
	    ...
	    return "c"
    elif 51 <= len(my_history) + 1 and len(my_history) <= 60: #if "bbb" in their_history, betray
        if "bbb" in their_history:
            return "b"
        else:
            return "c"
    elif 61 <= len(my_history) + 1 and len(my_history) <= 70: #if "ccc" in their_history, betray
        if "ccc" in their_history:
            return "b"
        else:
            return "c"
    elif 71 <= len(my_history) + 1 and len(my_history) <= 80: #return their thingy from 5 rounds back
        return their_history[-4]
    elif 81 <= len(my_history) + 1 and len(my_history) <= 90: #alternate, start on c
        if (len(my_history) + 1) % 2 == 0:
            return "b"
        else:
            return "c"
    elif 91 <= len(my_history) + 1 and len(my_history) <= 100: #always betray
        return "b"
    elif 101 <= len(my_history) + 1 and len(my_history) <= 110: #"bcbbcccbbb"
    ...
    elif 111 <= len(my_history) + 1 and len(my_history) <= 120: #if round number is divisible by 3, do c
        if (len(my_history) + 1) % 3 == 0:
            return "b"
        else:
            return "c"
    elif 121 <= len(my_history) + 1 and len(my_history) <= 130: #bccbbccbbc
    ...
    elif 131 <= len(my_history) + 1 and len(my_history) <= 140: #bbcbcbbbbc
    ...
    elif 141 <= len(my_history) + 1 and len(my_history) <= 150: #alternate, start on b
        if (len(my_history) + 1) % 2 == 0:
            return "c"
        else:
            return "b"
    elif 151 <= len(my_history) + 1 and len(my_history) <= 160: #bccbbbcccc
    ...
    elif 161 <= len(my_history) + 1 and len(my_history) <= 170: #cbbccbbccb
    ...
    elif 171 <= len(my_history) + 1 and len(my_history) <= 180: #cbbcccbbbb
    ...
    elif 181 <= len(my_history) + 1 and len(my_history) <= 190: #if round number is divisible by 3, do b
        if (len(my_history) + 1) % 3 == 0:
            return "c"
        else:
            return "b"
    elif 191 <= len(my_history) + 1 and len(my_history) <= 200: #always betray
        return "b"
    else:
